export function ContactForm() {
  ...
  <legend>Envianos tus comentarios</legend>
    <input type="text" name="name" placeholder="Escribe tu nombre"
      title="El nombre solo acepta letras y espacios en blancos" required pattern="^[A-Za-zÑñÁáÉéÍíÓóÚúÜü\\s]+$" />
  ...
  function validationsForm() {
    ...
    document.addEventListener("submit", (e) => {
      ...
      fetch("https://formsubmit.co/ajax/mmaattuumza@gmail.com", {
        method: "POST",
        // aunque ya tenemos un formulario, la ventaja de usar el objeto FormData,es que este parcea los valores del cada elemento del
        //formulario (osea el input y el texto que escribimos), este objeto puede recibir como parametro el objeto html form
        //NOTA: para que haga este parceo es muy importante que todos los input tienen que tener su atributo name establecedio, porque el
        //atributo name es el nombre de la variable cuando se envia el formulario.
